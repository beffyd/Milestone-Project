...
* [Wedding Packages Page](/docs/wedding-page-wireframe.png)
* [Birthday Packages Page](/docs/birthday-page-wireframe.png)
* [Contact Page](/docs/contact-page-wireframe.png)
* [Home Page mobile](/docs/home-page-mobile-wireframe.png)
* [Wedding Packages Page mobile](/docs/wedding-page-mobile-wireframe.png)
* [Birthday Packages Page mobile](/docs/birthday-page-mobile-wireframe.png)
* [Contact Page mobile](/docs/contact-page-mobile-wireframe.png)
...
The slideshow on index.html was written by username: gradar on the website: codepen.io, it can be found at: https://codepen.io/gradar/pen/BaavLLo

I used a bootstrap navbar for all pages which can be found at: https://getbootstrap.com/docs/4.0/components/navbar/#nav
...
- https://unsplash.com/ for all images on Rose's Flower Shop 
- https://fontawesome.com/ icons for the social media links and next to the phone number and email address on the contact page. 
...
To my brother Joe who knows how to code.

To my mentor Jubril Akolade.

To Tom from MySpace for encouraging me to write my first code.
